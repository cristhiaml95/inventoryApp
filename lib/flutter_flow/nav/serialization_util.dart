  ...
  try {
    ...
    switch (paramType) {
      ...
      case ParamType.SupabaseRow:
        ...
        switch (T) {
          case PresupuestoMenuRow:
            return PresupuestoMenuRow(data);
          case VInvMovFullRow:
            return VInvMovFullRow(data);
          case RrhhRow:
            return RrhhRow(data);
          case MainMenuRow:
            return MainMenuRow(data);
          case PresupuestoRow:
            return PresupuestoRow(data);
          case NivelesRow:
            return NivelesRow(data);
          case ModulosRow:
            return ModulosRow(data);
          case ProveedorRow:
            return ProveedorRow(data);
          case UnidadRow:
            return UnidadRow(data);
          case FamiliaRow:
            return FamiliaRow(data);
          case InventarioMovimientoRow:
            return InventarioMovimientoRow(data);
          case UsuariosRow:
            return UsuariosRow(data);
          case VInventarioFullRow:
            return VInventarioFullRow(data);
          case InventarioMenuRow:
            return InventarioMenuRow(data);
          case InventarioRow:
            return InventarioRow(data);
          case EventosRow:
